...
// void NetworkSaver::SaveNetwork(const char* databaseAddress,  Network* network,  bool override, bool print, int iterationNumber){
...
// Network* NetworkSaver::NetworkGetter(const char* databaseAddress){
//             sqlite3* db;
//             sqlite3_stmt * stmt;
//             char* err;
